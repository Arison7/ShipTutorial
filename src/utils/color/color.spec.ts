...
describe('>>> Color', () => {
  it('should throw an error if provided values are incorrect', () => {
    expect(() => new Color(266, 2, 3, 0.1)).toThrow()
    expect(() => new Color(-1, 2, 3, 0.1)).toThrow()
    expect(() => new Color(1.3, 2, 3, 0.1)).toThrow()

    expect(() => new Color(255, 266, 3, 0.1)).toThrow()
    expect(() => new Color(255, -1, 3, 0.1)).toThrow()
    expect(() => new Color(255, 2.5, 3, 0.1)).toThrow()

    expect(() => new Color(255, 25, 266, 0.1)).toThrow()
    expect(() => new Color(255, 25, -2, 0.1)).toThrow()
    expect(() => new Color(255, 0, 2.5, 0.1)).toThrow()

    expect(() => new Color(255, 255, 255, -1)).toThrow()
    expect(() => new Color(255, 255, 255, 1.2)).toThrow()
  })
